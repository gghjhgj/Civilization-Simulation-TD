...
void Walls::buildWalls(World &world, Civilization &civilization, WallsTypes type)
{
    ...
    for(int i = civilization.mostWestCivZone; i <= civilization.mostEastCivZone; i++)
    {
        ...
        if(type == woodenWall)
        {
            if(buildTop)
            {
                ...
                civilization.startConstruction(world, indexTop, Civilization::BuildingsType::woodWall);
            }
            if(buildBot)
            {
                civilization.resources.wood -= Config::woodNeededForWoodWall;
                civilization.startConstruction(world, indexBottom, Civilization::BuildingsType::woodWall);
            }
        }
        else if(type == stoneWall)
        {
            if(buildTop)
            {
                ...
                civilization.startConstruction(world, indexTop, Civilization::BuildingsType::stoneWall);
            }
            if(buildBot)
            {
                civilization.resources.stone -= Config::stoneNeededForStoneWall;
                civilization.startConstruction(world, indexBottom, Civilization::BuildingsType::stoneWall);
            }
        }
    }
    ...
    for(int i = civilization.mostNorthCivZone; i <= civilization.mostSouthCivZone; i++)
    {
        ...
        if(type == woodenWall)
        {
            ...
            {
                civilization.resources.wood -= Config::woodNeededForWoodWall;
                civilization.startConstruction(world, indexLeft, Civilization::BuildingsType::woodWall);
            }
            if(buildRight)
            {
                civilization.resources.wood -= Config::woodNeededForWoodWall;
                civilization.startConstruction(world, indexRight, Civilization::BuildingsType::woodWall);
            }
        }
        else if(type == stoneWall)
        {
            ...
            {
                civilization.resources.stone -= Config::stoneNeededForStoneWall;
                civilization.startConstruction(world, indexLeft, Civilization::BuildingsType::stoneWall);
            }
            if(buildRight)
            {
                civilization.resources.stone -= Config::stoneNeededForStoneWall;
                civilization.startConstruction(world, indexRight, Civilization::BuildingsType::stoneWall);
            }
        }
    }
